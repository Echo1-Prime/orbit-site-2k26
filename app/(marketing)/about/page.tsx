    ...
    <>
      ...
      <section className="section">
        <div className="container">
          ...
          <p className="body-lg" style={{ maxWidth: '640px', color: 'var(--e1-slate)' }}>
      ...
      {/* Why we exist */}
      <section className="section" style={{ borderTop: '1px solid var(--e1-border)' }}>
        <div className="container">
          ...
          <div style={{ maxWidth: '720px' }}>
            ...
            <p className="body-md" style={{ color: 'var(--e1-slate)' }}>
        ...
        <div className="container">
          ...
          <div
            style={{
              ...
              border: '1px solid var(--e1-border-accent)',
              borderRadius: 'var(--e1-radius)',
          ...
          >
            ...
            >
              &ldquo;<span style={{ color: 'var(--e1-ember)' }}>Built by operators.</span> Run by
              agents.{' '}
              <span style={{ color: 'var(--e1-ember)' }}>Supervised by humans</span> at scale.&rdquo;
            </p>
          </div>
          ...
          <InViewStagger className="grid-2">
            {PRINCIPLES.map((p) => (
              <Card key={p.num}>
                ...
                <p style={{ fontSize: '0.875rem', color: 'var(--e1-slate)', lineHeight: 1.7 }}>
                  {p.body}
                </p>
              </Card>
            ))}
      ...
      <section className="section" style={{ borderTop: '1px solid var(--e1-border)' }}>
        <div className="container">
          ...
          <p className="body-md" style={{ color: 'var(--e1-slate)', maxWidth: '640px', marginBottom: '2rem' }}>
            ...
            {APPS.map((app) => (
              ...
              >
                ...
                <div>
                  ...
                  <div style={{ fontSize: '0.75rem', color: 'var(--e1-slate)' }}>{app.cat}</div>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="section" style={{ borderTop: '1px solid var(--e1-border)' }}>
        <div className="container">
          ...
          <p className="body-md" style={{ color: 'var(--e1-slate)', marginBottom: '2rem' }}>
          ...
          <Card>
            ...
            >
              <div>
                ...
                <p style={{ fontSize: '0.875rem', color: 'var(--e1-slate)' }}>
