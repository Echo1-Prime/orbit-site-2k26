...
const TERMS: Term[] = [
  ...
  { name: 'Founding Cohort', def: 'The first group of businesses onboarded to the BLM OS. Founding Cohort members receive founding-cohort pricing, priority access to new layers as they ship, and direct input into the product development process. Access is application-based.' },
  ...
  { name: 'Ledger', def: 'The finance operations layer of the BLM OS. Ledger handles daily general ledger reconciliation, accounts payable routing and approval, cash flow monitoring and projection, and expense categorization. Native integration with QuickBooks. Available now.', tag: 'Layer 04' },
  ...
  { name: 'Owner-Led Business', def: 'A company where the owner or founder retains active operational authority, making or approving key decisions across revenue, finance, and operations. The BLM OS is built specifically for this profile: $5M to $100M revenue, 50 to 500 employees, no dedicated RevOps or marketing operations team.' },
