...
export const POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    category: 'Ledger',
    body: [
      { type: 'p', content: 'Ledger is the finance operations layer of the BLM OS. When it ships, it will handle daily general ledger reconciliation, accounts payable routing and approval, cash flow monitoring and projection, and expense categorization, through native integration with QuickBooks.' },
