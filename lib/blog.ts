...
export const POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    description: 'Lead qualification, deal intelligence, pipeline forecasting, and CRM hygiene — automated. Here is how the RevOps layer eliminates the operational overhead of a sales team.',
  ...
  },
  {
    ...
    category: 'Fundamentals',
    body: [
      { type: 'p', content: 'The Fusion Grid is the data integration and normalization layer of the BLM OS. It connects to the business\'s existing tools — CRM, accounting system, project management, communication platforms — and normalizes their data into a consistent schema that all seven agent layers can operate against without custom translation logic per source.' },
      { type: 'h2', content: 'What it connects' },
      { type: 'p', content: 'The Fusion Grid connects to the tools the business already uses: CRM, QuickBooks, project management software, email and calendar, communication platforms, and document storage. It does not replace any of these tools. It reads from them, normalizes the data, and makes it available to the agent layer.' },
  ...
  },
  {
    ...
    description: 'GL reconciliation, AP routing, cash flow monitoring, and expense categorization — without adding headcount. Ledger is coming soon to the BLM OS.',
    datePublished: '2026-09-15',
    readingTime: '5 min',
    category: 'Ledger',
    body: [
      { type: 'p', content: 'Ledger is the finance operations layer of the BLM OS. When it ships, it will handle daily general ledger reconciliation, accounts payable routing and approval, cash flow monitoring and projection, and expense categorization — native integration with QuickBooks.' },
      { type: 'p', content: 'Ledger is currently in development. Founding Cohort members are on the waitlist for early access.' },
  ...
  },
  {
    ...
    body: [
      ...
      { type: 'p', content: 'Automates daily GL reconciliation, AP processing, cash flow monitoring, and expense categorization. Coming soon.' },
