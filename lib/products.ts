...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    capabilities: [
      ...
      { name: 'Multi-Channel Scheduling', desc: 'One content queue powers all connected channels. Timing, format, and platform are handled by the Social Scheduler. You approve the content; it handles the rest.' },
